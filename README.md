...
The intent is to store the file "S99-wireguard" in the default user's home directory as:
  /home/tc/S99-wireguard

The file will be executed each time the PCP server boots by added that as user command via the PCP web gui, through:
